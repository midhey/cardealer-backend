...
fun Route.getAllEquipmentsByData(
    ...
    get("/read-equipments/{modelId}/{bodyId}/{transmissionId}/{engineId}") {
        ...
        val engineId = call.parameters["engineId"]?.toShortOrNull()
        val equipments = equipmentService.readAllEquipmentsByData(
            modelId!!,
            bodyId!!,
            transmissionId!!,
            engineId!!
